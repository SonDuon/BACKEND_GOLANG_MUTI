# Frontend AngularJS 1.x - Movie Streaming

Đây là giao diện frontend sử dụng **AngularJS 1.x** cho hệ thống streaming phim với backend Golang Gin.
...
└── app.js        # AngularJS controller và logic
```
